         ...
         while (1){
          ...
          retornoEscolhaBatalha:
            ...
            if (hpZumbi <= 0){          //DISTRIBUI XP E RETORNA UM NUMERO QUALQUER
                ...
                printf (" Voce disfere um golpe fatal no cranio do homem de aspecto cadaverico e com um\n"
                        " baque ele vai ao chao enquanto seu corpo para de reagir.\n");
                printf ("\n { Voce acaba de receber + %i pontos de experiencia. }\n\n", xp);
              return 2;
            }

            printf ("|:| Rodada - %i |:|----|----|----|----|----|----|:| |[  Fim do Turno  ]|\n", turnos);
            printf ("\n");
            ...
            switch (danoZumbi){
                ...
                case 1:
                  ...
                  break;
                case 8:
                  printf (" O ser avanca rapidamente em sua direcao e morde seu braco violentamente arran-\n"
                          " cando parte de sua carne.\n");
                  break;
                default:
                  printf (" Ele usa as unhas para te arranhar.\n");
            }
